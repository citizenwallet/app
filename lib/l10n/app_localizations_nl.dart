...
class AppLocalizationsNl extends AppLocalizations {
  ...
  @override
  String get aWalletForYourCommunity => 'Dit is je nieuwe wallet, waar je de tokens van je gemeenschap kunt opslaan, verzenden en ontvangen.';
  ...
  @override
  String get recoverIndividualAccountFromaPrivatekey => 'Herstel een individuele account via een private key.';

  @override
  String get createNewAccountMsg => 'Creëer een profiel zodat mensen gemakkelijk tokens kunnen sturen naar uw gebruikersnaam.';
  ...
  @override
  String get yourContactsWillAppearHere => 'Uw contactpersonen verschijnen hier';

  @override
  String get accountsAndroidBackupsuseAndroid => 'Back-ups maken gebruik van Android Auto Backup en volgen automatisch de back-upinstellingen van je toestel.';

  @override
  String get accountsAndroidIfYouInstalltheAppAgain => 'Als je de app opnieuw installeert op een ander apparaat met hetzelfde Google-account, wordt de versleutelde back-up gebruikt om je accounts te herstellen.';

  @override
  String get accountsAndroidYouraccounts => 'Uw accounts en back-ups worden door u aangemaakt en zijn volledig uw eigendom. ';

  @override
  String get accountsAndroidManuallyExported => 'Ze kunnen op elk moment handmatig worden geëxporteerd.';

  @override
  String get accountsApYouraccountsarebackedup => 'Van je accounts wordt een back-up gemaakt in de Keychain van je iPhone en ze volgen automatisch je iCloud back-upinstellingen.';

  @override
  String get accountsApSyncthisiPhone => 'Als je \"Sync this iPhone\" inschakelt, wordt er een back-up van je keychain van je iPhone gemaakt in iCloud. ';

  @override
  String get accountsApYoucancheck => 'Je kunt controleren of synchronisatie is ingeschakeld in je Instellingen door te gaan naar: Apple ID > iCloud > Wachtwoorden en Keychain. ';

  @override
  String get accountsApYouraccounts => 'Uw accounts en back-ups van uw accounts worden door u aangemaakt en zijn volledig uw eigendom. ';

  @override
  String get accountsApTheycanbe => 'Ze kunnen op elk moment handmatig worden geëxporteerd.';
  ...
  @override
  String get androidBackupTexlineOne => 'Er is al een back-up op je Google Drive-account gelinkt met een andere account';

  @override
  String get androidBackupTexlineTwo => 'Weet je zeker dat je deze wilt vervangen?';

  @override
  String get appResetTexlineOne => 'Weet je zeker dat je alles wilt verwijderen?';

  @override
  String get appResetTexlineTwo => 'Deze actie kan niet ongedaan worden gemaakt.';
  ...
  @override
  String get endToEndEncryptionSub => 'Back-ups zijn altijd end-to-end versleuteld.';

  @override
  String get accountsSubLableOne => 'Van al je accounts wordt automatisch een back-up gemaakt in de sleutelhanger van je apparaat en ze worden gesynchroniseerd met je iCloud-Keychain.';
  ...
  @override
  String get accountsSubLableLastBackUpSecond => 'Maak nu een back-up van je accounts op je Google Drive-account.';
  ...
  @override
  String get noKeysFoundTryManually => 'Geen account-keys gevonden, probeer handmatig in te voeren.';

  @override
  String get getEncryptionKeyFromYourPasswordManager => 'Haal de coderingssleutel op uit uw Password Manager';

  @override
  String get invalidKeyEncryptionKey => 'Ongeldige coderingssleutel.';

  @override
  String get enterEncryptionKeyManually => 'Coderingssleutel handmatig invoeren';
  ...
  @override
  String get itLivesInTheLinkOfThisPage => 'Je wallet gegevens zitten in de link van deze pagina.';

  @override
  String get itIsUniqueToYouAndYourCommunity => 'Het is uniek voor jou en je gemeenschap.';

  @override
  String get keepYourLink => 'Houd je link privé om ervoor te zorgen dat alleen jij toegang hebt tot deze wallet.';
  ...
  @override
  String get recoverIndividualAccount => 'Individuele account herstellen met een private key';

  @override
  String get restoreAllAccountsGoogleDrive => 'Alle accounts herstellen via Google Drive';

  @override
  String get infoActionLayoutDescription => 'Je wordt gevraagd om in te loggen op je Google account. We vragen alleen toegang tot de map van deze app in je Google Drive.';

  @override
  String get connectYourGoogleDriveAccount => 'Verbind met je Google Drive Account';

  @override
  String get recoverIndividualAccountPrivateKey => 'Herstel individuele account via een private key';
  ...
  @override
  String get thisUsernameIsAlreadyTaken => 'Deze gebruikersnaam wordt reeds gebruikt.';
  ...
  @override
  String get failedSaveProfile => 'Het is niet gelukt om het profiel op te slaan.';
  ...
  @override
  String get saveText1 => 'Verlies je wallet niet! Bookmark deze pagina of bewaar het unieke adres met je private key op een veilige plek.';
  ...
  @override
  String get shareText2 => 'Indien ze nog geen wallet hebben, wordt er een nieuwe Citizen Wallet aangemaakt op hun apparaat.';
  ...
  @override
  String get deleteaccountMsg1 => 'Weet je zeker dat je deze account wilt verwijderen?';

  @override
  String get deleteaccountMsg2 => 'Deze actie kan niet ongedaan worden gemaakt.';
  ...
  @override
  String get deleteVoucherMsg => 'Hierdoor wordt de voucher uit de lijst verwijderd.';
  ...
  @override
  String get createVoucherText => 'Maak een voucher die iedereen kan claimen voor het bovenstaande bedrag.';
