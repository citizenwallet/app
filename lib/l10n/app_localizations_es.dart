...
class AppLocalizationsEs extends AppLocalizations {
  ...
  String get confirmActionSub =>
      '¿Estás seguro de que quieres confirmar esta acción?';
  ...
  String get aWalletForYourCommunity =>
      'Esta es tu nueva billetera, donde puedes almacenar, enviar y recibir los tokens de tu comunidad.';
  ...
  String get recoverIndividualAccountFromaPrivatekey =>
      'Recuperar cuenta individual desde una clave privada';
  ...
  String get accountsAndroidBackupsuseAndroid =>
      'Las copias de seguridad usan la copia automática de Android y siguen la configuración de respaldo de tu dispositivo automáticamente.';

  @override
  String get accountsAndroidIfYouInstalltheAppAgain =>
      'Si instalas la aplicación nuevamente en otro dispositivo que comparta la misma cuenta de Google, se usará la copia de seguridad cifrada para restaurar tus cuentas.';

  @override
  String get accountsAndroidYouraccounts =>
      'Tus cuentas y las copias de seguridad de tus cuentas son generadas y poseídas por ti.';

  @override
  String get accountsAndroidManuallyExported =>
      'Pueden ser exportadas manualmente en cualquier momento.';

  @override
  String get accountsApYouraccountsarebackedup =>
      'Tus cuentas están respaldadas en el llavero de tu iPhone y siguen tu configuración de respaldo automáticamente.';

  @override
  String get accountsApSyncthisiPhone =>
      'Habilitar \"Sincronizar este iPhone\" asegurará que el llavero de tu iPhone se respalde en iCloud.';

  @override
  String get accountsApYoucancheck =>
      'Puedes verificar si la sincronización está habilitada en la aplicación Configuración yendo a: ID de Apple > iCloud > Contraseñas y Llavero.';
  ...
  String get androidBackupTexlineOne =>
      'Ya existe una copia de seguridad en tu cuenta de Google Drive con diferentes credenciales.';

  @override
  String get androidBackupTexlineTwo =>
      '¿Estás seguro de que quieres reemplazarla?';
  ...
  String get endToEndEncryptionSub =>
      'Las copias de seguridad siempre están cifradas de extremo a extremo.';

  @override
  String get accountsSubLableOne =>
      'Todas tus cuentas se respaldan automáticamente en el llavero de tu dispositivo y se sincronizan con tu llavero de iCloud.';
  ...
  String get accountsSubLableLastBackUpSecond =>
      'Respalda tus cuentas en tu cuenta de Google Drive.';
  ...
  String get noKeysFoundTryManually =>
      'No se encontraron claves, intenta ingresar manualmente.';

  @override
  String get getEncryptionKeyFromYourPasswordManager =>
      'Obtén la clave de cifrado desde tu administrador de contraseñas';
  ...
  String get enterEncryptionKeyManually =>
      'Ingresa la clave de cifrado manualmente';
  ...
  String get itIsUniqueToYouAndYourCommunity =>
      'Es único para ti y tu comunidad.';

  @override
  String get keepYourLink =>
      'Mantén tu enlace privado para asegurarte de que solo tú tengas acceso a esta billetera.';
  ...
  String get restoreAllAccountsGoogleDrive =>
      'Restaurar todas las cuentas desde Google Drive';

  @override
  String get infoActionLayoutDescription =>
      'Se te pedirá que inicies sesión en tu cuenta de Google. Solo solicitaremos acceso a la carpeta de esta aplicación en tu Google Drive.';
  ...
  String get thisUsernameIsAlreadyTaken =>
      'Este nombre de usuario ya está tomado.';
  ...
  String get saveText1 =>
      '¡No pierdas tu billetera! Marca esta página como favorita o guarda su dirección única que contiene tu clave privada en un lugar seguro.';

  @override
  String get gettheapp =>
      'Alternativamente, puedes descargar la aplicación Citizen Wallet e importar tu billetera allí.';
  ...
  String get opentheapp =>
      'Una vez instalada, puedes importar tu billetera web en la aplicación.';
  ...
  String get emailtoyourselfyourwalleturl =>
      'Envía por correo a ti mismo la URL de tu billetera';
  ...
  String get shareText2 =>
      'Si no tienen una, se creará una nueva Billetera Ciudadana en su dispositivo.';
  ...
  String get createVoucherText =>
      'Crea un vale que cualquiera pueda canjear por el monto mostrado arriba.';
