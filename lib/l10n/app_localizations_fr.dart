...
class AppLocalizationsFr extends AppLocalizations {
  ...
  @override
  String get aWalletForYourCommunity => 'Ceci est votre nouveau portefeuille, où vous pouvez stocker, envoyer et recevoir les jetons de votre communauté.';
  ...
  @override
  String get recoverIndividualAccountFromaPrivatekey => 'Récupérer un compte individuel à partir d\'une clé privée';

  @override
  String get createNewAccountMsg => 'Créez un profil pour faciliter l\'envoi de jetons vers vous.';
  ...
  @override
  String get accountsAndroidBackupsuseAndroid => 'Les sauvegardes utilisent la sauvegarde automatique Android et suivent les paramètres de sauvegarde de votre appareil automatiquement.';

  @override
  String get accountsAndroidIfYouInstalltheAppAgain => 'Si vous installez l\'application de nouveau sur un autre appareil utilisant le même compte Google, la sauvegarde chiffrée sera utilisée pour restaurer vos comptes.';

  @override
  String get accountsAndroidYouraccounts => 'Vos comptes et les sauvegardes de vos comptes vous appartiennent.';

  @override
  String get accountsAndroidManuallyExported => 'Ils peuvent être exportés manuellement à tout moment.';

  @override
  String get accountsApYouraccountsarebackedup => 'Vos comptes sont sauvegardés dans le trousseau de votre iPhone et suivent vos paramètres de sauvegarde automatiquement.';

  @override
  String get accountsApSyncthisiPhone => 'Activer \"Synchroniser cet iPhone\" garantira que le trousseau de votre iPhone soit sauvegardé sur iCloud.';

  @override
  String get accountsApYoucancheck => 'Vous pouvez vérifier si la synchronisation est activée dans votre application Paramètres en allant à : Identifiant Apple > iCloud > Mots de passe et trousseau.';

  @override
  String get accountsApYouraccounts => 'Vos comptes et les sauvegardes de vos comptes sont générés et vous appartiennent.';

  @override
  String get accountsApTheycanbe => 'Ils peuvent être exportés manuellement à tout moment.';
  ...
  @override
  String get androidBackupTexlineOne => 'Il existe déjà une sauvegarde dans votre compte Google Drive à partir de différents identifiants.';

  @override
  String get androidBackupTexlineTwo => 'Êtes-vous sûr de vouloir la remplacer?';
  ...
  @override
  String get endToEndEncryptionSub => 'Les sauvegardes sont toujours chiffrées de bout en bout.';

  @override
  String get accountsSubLableOne => 'Tous vos comptes sont automatiquement sauvegardés dans le trousseau de votre appareil et synchronisés avec votre trousseau iCloud.';
  ...
  @override
  String get accountsSubLableLastBackUpSecond => 'Sauvegardez vos comptes sur votre compte Google Drive.';
  ...
  @override
  String get noKeysFoundTryManually => 'Aucune clé trouvée, essayez manuellement.';

  @override
  String get getEncryptionKeyFromYourPasswordManager => 'Obtenir la clé de chiffrement de votre gestionnaire de mots de passe';

  @override
  String get invalidKeyEncryptionKey => 'Clé de chiffrement invalide.';

  @override
  String get enterEncryptionKeyManually => 'Entrer la clé de chiffrement manuellement';
  ...
  @override
  String get itLivesInTheLinkOfThisPage => 'Il se trouve dans le lien de cette page.';

  @override
  String get itIsUniqueToYouAndYourCommunity => 'Il est unique pour vous et votre communauté.';

  @override
  String get keepYourLink => 'Gardez votre lien privé pour vous assurer que vous seul avez accès à ce portefeuille.';
  ...
  @override
  String get recoverIndividualAccount => 'Récupérer un compte individuel à partir d\'une clé privée';

  @override
  String get restoreAllAccountsGoogleDrive => 'Restaurer tous les comptes depuis Google Drive';

  @override
  String get infoActionLayoutDescription => 'Vous devrez vous connecter à votre compte Google. Nous demanderons uniquement l\'accès au dossier de cette application dans votre Google Drive.';

  @override
  String get connectYourGoogleDriveAccount => 'Connecter votre compte Google Drive';

  @override
  String get recoverIndividualAccountPrivateKey => 'Récupérer un compte individuel à partir d\'une clé privée';
  ...
  @override
  String get saveText1 => 'Ne perdez pas votre portefeuille ! Mettez cette page en favori ou sauvegardez son adresse unique contenant votre clé privée dans un endroit sûr.';

  @override
  String get gettheapp => 'Vous pouvez également télécharger l\'application et y importer votre portefeuille.';
  ...
  @override
  String get opentheapp => 'Une fois installée, vous pouvez importer votre portefeuille.';

  @override
  String get open => 'Importer dans l\'appplication';

  @override
  String get copyyouruniquewalletURL => 'Copiez l\'URL unique de votre portefeuille';

  @override
  String get emailtoyourselfyourwalleturl => 'Envoyez-vous par courriel l\'URL de votre portefeuille';

  @override
  String get shareText1 => 'Faites scanner ce code QR par quelqu\'un d\'autre.';

  @override
  String get shareText2 => 'S\'ils n\'en ont pas déjà un, cela créera un nouveau portefeuille Citoyen sur leur appareil.';
  ...
  @override
  String get deleteaccountMsg1 => 'Êtes-vous sûr de vouloir supprimer ce compte ?';
  ...
  @override
  String get createVoucherText => 'Créer un bon échangeable contre le montant indiqué ci-dessus.';
