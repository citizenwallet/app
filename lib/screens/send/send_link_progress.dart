                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                            ...
                            children: [
                              !_isReady
                                  ? Container(
                                      ...
                                      child: ProgressCircle(
                                        progress: switch (creationState) {
                                          VoucherCreationState.creating => 0.5,
                                          VoucherCreationState.funding => 1,
                                          VoucherCreationState.created => 1,
                                          _ => 0,
                                        },
                                        size: 100,
                                        color: Theme.of(context)
                                  ...
                                  : AnimatedOpacity(
                                      ...
                                      opacity: _isReady && !createError ? 1 : 0,
                                      child: QR(
                                        data: shareLink,
                                        size: size * 0.8,
                                      ),
                          ...
                          Text(
                            isCreating
                                ? AppLocalizations.of(context)!.voucherCreating
                                : !createError
